...
const columns = useI18nReactive<VxeGridPropTypes.Column<any>[]>(() => {
  return [
    { type: 'seq', width: 50 },
    { field: 'CODE', title: t('gvJob_CODE', '编码'), width: 100 },
    { field: 'CNAME', title: t('gvJob_CNAME', '名称') }
  ]
})
// 查询语句
const sql = () => remoteSqlMap['工序的查询'].DBQUERY
const sortby = () => remoteSqlMap['工序的查询'].SORTBYCONTENT
