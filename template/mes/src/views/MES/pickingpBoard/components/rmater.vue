  ...
  <div class="gauge flex-column box-r box-s black-box p-10" style="padding-bottom: 0">
    ...
    <div class="flex-column flex-align-center">
      ...
      <div class="c-white text-lg mt10 mb10 flex-align-center" style="width: 100%">
        <span style="width: 50%" class="text-right">已完成：</span>
        <span class="c-blue text-bold flex1" style="font-size: 26px">{{ PSQTY }}</span>
      </div>
      <div class="c-white text-lg mt10 mb10 flex-align-center" style="width: 100%">
        <span style="width: 50%" class="text-right">待完成：</span>
...
const refresh = () => {
  ...
  props.resData.forEach((item) => {
    PSQTY.value += item.WCQTY || 0
    QTY.value += item.DCQTY || 0
  })
  value = (PSQTY.value / (PSQTY.value + QTY.value)).toFixed(4) * 100
  if (value >= 100) {
    lightColor = '#ff8c55'
    blackColor = '#c10100'
  }
