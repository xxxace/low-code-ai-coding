...
const remoteSqlMap = useRemoteSqlMap({ objectName: 'VUE_MES_PSTASK_GD' })
...
const columns = useI18nReactive<VxeGridPropTypes.Column<any>[]>(() => {
  return [
    { type: 'seq', width: 50 },
    { field: 'WCSEQ', title: t('gvWorkShop_WCSEQ', '编码'), width: 100 },
    { field: 'CNAME', title: t('gvWorkShop_CNAME', '名称') }
  ]
})
// 查询语句
const sql = () => remoteSqlMap['车间产线的查询语句'].DBQUERY
const sortby = () => remoteSqlMap['车间产线的查询语句'].SORTBYCONTENT
