  ...
  <div class="gauge flex-column box-r box-s black-box p-10" style="padding-bottom: 0">
    ...
    <div class="flex-column flex-align-center">
      <div class="mt10 c-white text-lg mt10 flex-align-center" style="width: 100%">
        <span style="width: 50%" class="text-right">已收料：</span>
        <span class="c-blue text-bold flex1" style="font-size: 26px">{{ QTY || 5197.2 }}</span>
      </div>
      <div class="c-white text-lg mt10 mb10 flex-align-center" style="width: 100%">
        <span style="width: 50%" class="text-right">欠收料：</span>
        <span class="c-blue text-bold flex1" style="font-size: 26px">{{ PSQTY || 1277.8 }}</span>
      </div>
    </div>
