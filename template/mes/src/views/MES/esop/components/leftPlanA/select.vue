<template>
    <div>
        <div class="select-box flex-column">
            ...
            <div style="overflow: auto;">
                <div
                    v-for="(item, index) in evtItem.marksList"
                    :key="index"
                    class="flex-align-center mt10"
                >
                    <span class="mr10">{{ $t("notes") }}{{ index + 1 }}:</span>
                    <el-input v-model="item.text" type="textarea" autosize class="flex1">
                    </el-input>
                    <el-button
                        type="danger"
                        icon="el-icon-delete"
        ...
        <!-- 弹窗 -->
        <el-dialog :title="evtItem.name" :visible.sync="diaShow" append-to-body>
