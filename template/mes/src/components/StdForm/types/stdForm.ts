import { RefManager, RefManagerArray } from '@/hooks/nameson/useRefManager'
import { TableRelationManager } from '@/hooks/nameson/useTableRelation'
...
export type DataLoader = {
  loader:
    | (<T extends object>(params?: Record<string, any>) => T)
    | (<T extends object>() => Promise<T>)
  params?: Record<string, any>
