<template>
  <!-- <div class="ace-fieldset position-relative border border-solid border-gray-300 p-2 mb-3">
    <div v-if="props.legend" class="position-absolute top-0 left-0">{{ props.legend }}</div>
    <slot></slot>
  </div> -->
  <fieldset
